-- Finish onboarding exactly once. Profile changes and optional imported
-- students commit together; retries observe onboarding_completo and do not
-- duplicate students.
...
GRANT EXECUTE ON FUNCTION public.finalizar_onboarding(uuid, boolean, text, text, text, boolean, integer, jsonb) TO authenticated, service_role;
