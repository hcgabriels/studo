-- Convert a trial into a student without leaving partial student, schedule or
-- lesson records. Keep tipo='experimental' so conversion metrics remain true.
...
REVOKE ALL ON FUNCTION public.converter_aula_experimental(uuid, uuid, text, text, text, integer, time, integer, numeric) FROM PUBLIC, anon;

GRANT EXECUTE ON FUNCTION public.converter_aula_experimental(uuid, uuid, text, text, text, integer, time, integer, numeric) TO authenticated, service_role;
