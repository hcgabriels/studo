-- Bulk import students and their optional recurring schedules in one
-- set-based statement. Generated IDs keep each schedule tied to its source
-- row without relying on RETURNING order or student names.
...
GRANT EXECUTE ON FUNCTION public.importar_alunos(uuid, jsonb) TO authenticated, service_role;
