CREATE OR REPLACE FUNCTION public.usar_aula_pacote (
  p_pacote_id uuid
)
  RETURNS TABLE (
    out_aulas_usadas integer,
    out_status       text
  )
  LANGUAGE plpgsql
  SECURITY INVOKER
...
GRANT EXECUTE ON FUNCTION "public"."usar_aula_pacote"(uuid) TO "authenticated", "postgres", "service_role";
